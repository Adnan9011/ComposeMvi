object Version {
    // Plugin
    const val applicationPluginVersion = "7.1.2"
    const val libraryPluginVersion = "7.1.2"
    const val kotlinPluginVersion = "1.6.10"

    // Classpath
    const val hiltClasspath = "2.40.5"
    ...
    const val lifecycleReactiveVersion = "2.4.1"
    ...
    const val hiltCompileVersion = "1.0.0"
    const val hiltAndroidxVersion = "1.0.0-alpha02"

    // Retrofit
    const val retrofitVersion = "2.9.0"
    const val loggingInterceptorVersion = "4.5.0"
    ...
    const val ktxFragmentVerstion = "1.4.1"
    const val ktxActivityVerstion = "1.4.0"
    const val ktxLifecycleVerstion = "2.4.1"
    ...
    const val composeLifecycleVersion = "2.3.1"
